...
import com.example.dbattempt.DeleteCowActivity;
...
public class SearchResultsDeleteCowActivity extends DeleteCowActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_search_results_delete_cow);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.search_results_delete_cow, menu);
		return true;
	}
