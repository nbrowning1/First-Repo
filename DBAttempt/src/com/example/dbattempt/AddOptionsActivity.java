...
public class AddOptionsActivity extends Activity {
	...
	public void goToAddCalf(View view) {
    	Intent intent = new Intent(this, AddCowActivity.class);
		startActivity(intent);
    }
    
    public void goToAddMedicalRecord(View view) {
    	Intent intent = new Intent(this, AddMedicalRecordActivity.class);
		startActivity(intent);
    }
    
    public void goToAddDehorningEvent(View view) {
    	Intent intent = new Intent(this, AddDehorningEventActivity.class);
		startActivity(intent);
    }
